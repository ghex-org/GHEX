...
class UnitRange(IntegerSet):
    ...
    def complement(self, other: Union[None, Set] = None, simplify=True):
        ...
        result = union(UnitRange(-math.inf, self.start), UnitRange(self.stop, math.inf), disjoint=True, simplify=simplify)
...
class UnionRange(IntegerSet, UnionMixin):
    ...
    def bounds(self) -> UnitRange:
        ...
        return UnitRange(functools.reduce(min, (arg.start for arg in self.args)),
