...
struct communication_object_exporter {
    ...
    void operator() (pybind11::module_& m, py::class_<communication_object_type> cls) {
        std::cout << "Communication Object: "
                   << gridtools::ghex::bindings::python::utils::demangle<communication_object_type>()
                   << std::endl;
        ...
        gridtools::for_each<gridtools::meta::transform<type_container,
            ...
            cls.def("exchange", [] (communication_object_type& co, buffer_info_type& b) { return co.exchange(b); });
        });
    }
};
