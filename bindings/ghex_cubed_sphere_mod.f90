MODULE ghex_cubed_sphere_mod
  ...
  interface ghex_delete
     subroutine ghex_cubed_sphere_exchange_desc_delete(exchange_desc) bind(c, name="ghex_obj_delete")
       use iso_c_binding
       import ghex_cubed_sphere_exchange_descriptor
       type(ghex_cubed_sphere_exchange_descriptor) :: exchange_desc
     end subroutine ghex_cubed_sphere_exchange_desc_delete

     subroutine ghex_cubed_sphere_exchange_handle_delete(exchange_handle) bind(c, name="ghex_obj_delete")
       use iso_c_binding
       import ghex_cubed_sphere_exchange_handle
       type(ghex_cubed_sphere_exchange_handle) :: exchange_handle
     end subroutine ghex_cubed_sphere_exchange_handle_delete

     subroutine ghex_cubed_sphere_domain_delete(domains_desc) bind(c)
       use iso_c_binding
       import ghex_cubed_sphere_domain
       type(ghex_cubed_sphere_domain) :: domains_desc
     end subroutine ghex_cubed_sphere_domain_delete

     subroutine ghex_cubed_sphere_co_delete(co) bind(c, name="ghex_obj_delete")
       use iso_c_binding
