MODULE ghex_comm_mod
  ...
  interface
     ...
     type(ghex_request) function comm_post_send_cb_wrapped(comm, message, rank, tag, cb) bind(c, name="comm_post_send_cb")
       use iso_c_binding
       import ghex_communicator, ghex_message, ghex_request
       type(ghex_communicator), value :: comm
       type(ghex_message), value :: message
       ...
       integer(c_int), value :: tag
       type(c_funptr), value :: cb
     end function comm_post_send_cb_wrapped

     type(ghex_future) function comm_post_send_wrapped(comm, message, rank, tag) bind(c, name="comm_post_send")
       use iso_c_binding
       ...
       integer(c_int), value :: rank
       integer(c_int), value :: tag
     end function comm_post_send_wrapped
     ...
     type(ghex_request) function comm_post_recv_cb_wrapped(comm, message, rank, tag, cb) bind(c, name="comm_post_recv_cb")
       use iso_c_binding
       import ghex_communicator, ghex_message, ghex_request
       type(ghex_communicator), value :: comm
       type(ghex_message), value :: message
       ...
       integer(c_int), value :: tag
       type(c_funptr), value :: cb
     end function comm_post_recv_cb_wrapped

     type(ghex_future) function comm_post_recv_wrapped(comm, message, rank, tag) bind(c, name="comm_post_recv")
       use iso_c_binding
       import ghex_communicator, ghex_message, ghex_future
       type(ghex_communicator), value :: comm
       type(ghex_message), value :: message
       integer(c_int), value :: rank
       integer(c_int), value :: tag
     end function comm_post_recv_wrapped

     type(ghex_request) function comm_resubmit_recv_wrapped(comm, message, rank, tag, cb) bind(c, name="comm_resubmit_recv")
       use iso_c_binding
       import ghex_communicator, ghex_message, ghex_request
       type(ghex_communicator), value :: comm
       type(ghex_message), value :: message
       ...
       integer(c_int), value :: tag
       type(c_funptr), value :: cb
     end function comm_resubmit_recv_wrapped
...
CONTAINS
  ...
  type(ghex_request) function comm_post_send_cb(comm, message, rank, tag, cbarg)
    use iso_c_binding
    type(ghex_communicator), intent(in) :: comm
    type(ghex_message), value :: message
    integer, intent(in) :: rank
    ...
    comm_post_send_cb = comm_post_send_cb_wrapped(comm, message, rank, tag, c_funloc(cb))
  end function comm_post_send_cb

  type(ghex_future) function comm_post_send(comm, message, rank, tag)
    use iso_c_binding
    type(ghex_communicator), intent(in) :: comm
    type(ghex_message), value :: message
    integer, intent(in) :: rank
    ...
    comm_post_send = comm_post_send_wrapped(comm, message, rank, tag)
  end function comm_post_send
  ...
  type(ghex_request) function comm_post_recv_cb(comm, message, rank, tag, cbarg)
    use iso_c_binding
    type(ghex_communicator), intent(in) :: comm
    type(ghex_message), value :: message
    integer, intent(in) :: rank
    ...
    cb => cbarg
    comm_post_recv_cb = comm_post_recv_cb_wrapped(comm, message, rank, tag, c_funloc(cb))
  end function comm_post_recv_cb

  type(ghex_future) function comm_post_recv(comm, message, rank, tag)
    use iso_c_binding
    type(ghex_communicator), intent(in) :: comm
    type(ghex_message), value :: message
    integer, intent(in) :: rank
    ...
    comm_post_recv = comm_post_recv_wrapped(comm, message, rank, tag)
  end function comm_post_recv

  type(ghex_request) function comm_resubmit_recv(comm, message, rank, tag, cbarg)
    use iso_c_binding
    type(ghex_communicator), intent(in) :: comm
    type(ghex_message), value :: message
    integer, intent(in) :: rank
    ...
    procedure(f_callback), pointer :: cb
    cb => cbarg
    comm_resubmit_recv = comm_resubmit_recv_wrapped(comm, message, rank, tag, c_funloc(cb))
  end function comm_resubmit_recv
