...
TEST(communication_object, constructor) {
    ...
    using communication_object_t = gridtools::ghex::communication_object<decltype(patterns)::value_type,
            gridtools::ghex::cpu>;
...
TEST(communication_object, exchange_multiple_fields) {
    ...
    triple_t<USE_DOUBLE,
        int>* _values_1 = new triple_t<USE_DOUBLE, int>[(DIM1 + H1m + H1p) * (DIM2 + H2m + H2p) * (DIM3 + H3m + H3p)];
...
TEST(communication_object, multithreading_multiple_fileds) {
    ...
    triple_t<USE_DOUBLE,
        int>* _values_1_1 = new triple_t<USE_DOUBLE, int>[(DIM1 + H1m + H1p) * (DIM2 + H2m + H2p) * (DIM3 + H3m + H3p)];
    ...
    triple_t<USE_DOUBLE,
        int>* _values_2_1 = new triple_t<USE_DOUBLE, int>[(DIM1 + H1m + H1p) * (DIM2 + H2m + H2p) * (DIM3 + H3m + H3p)];
