    ...
    namespace ghex {
        namespace threads {
            namespace std_thread {
                ...
                template<typename F>
                using void_return_type =
                    typename std::enable_if<std::is_same<boost::callable_traits::return_type_t<F>, void>::value,
                                            void>::type;
                ...
                public:
                    ...
                    token get_token() noexcept {
                        ...
                        if (new_id == 0) { m_tokens[new_id]->set_selected(true); }
                    ...
                    void barrier(token& bt) /*const*/ {
                        ...
                        if (m_barrier_cnt[bt.epoch()] == 0) {
                            ...
                            m_cv_up[bt.epoch()].wait(
                                lock, [this, &bt] { return m_barrier_cnt[bt.epoch()] == m_num_threads; });
                            ...
                            if (m_up_counter[bt.epoch()] == m_num_threads - 1) {
                                ...
                                m_barrier_cnt[bt.epoch()] =
                                    m_num_threads; // done by multiple threads, but this resets the counter
