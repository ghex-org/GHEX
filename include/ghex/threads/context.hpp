 ...
 * 
 */
#ifndef INCLUDED_GHEX_THREADS_CONTEXT_CONTEXT_HPP
...
namespace gridtools {
    namespace ghex {
        namespace threads {
            ...
            public: // ctors
                context(int num_threads) noexcept
            ...
            public: // public member functions
                ...
                template <typename F>
                inline void critical(F && f) const noexcept { f(); }
            };
#endif
...
#endif /* INCLUDED_GHEX_THREADS_CONTEXT_CONTEXT_HPP */
