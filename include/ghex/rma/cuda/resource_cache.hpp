 ...
 * 
 */
#ifndef INCLUDED_GHEX_RMA_CUDA_RESOURCE_CACHE_HPP
#define INCLUDED_GHEX_RMA_CUDA_RESOURCE_CACHE_HPP
...
// singleton pattern
static inline resource_cache& get_cache()
{
...
#endif /* INCLUDED_GHEX_RMA_CUDA_RESOURCE_CACHE_HPP */
