    ...
    namespace ghex {
        ...
        namespace allocator {
            ...
            struct mpi_allocator {
                ...
                template<class U>
                constexpr mpi_allocator(const mpi_allocator<U>&) noexcept {}
                ...
                void deallocate(T* p, std::size_t) noexcept { MPI_Free_mem(p); }
            ...
            bool operator==(const mpi_allocator<T>&, const mpi_allocator<U>&) {
                return true;
            }
            template<class T, class U>
            bool operator!=(const mpi_allocator<T>&, const mpi_allocator<U>&) {
