        ...
        namespace tl {
            ...
            private:
                ...
                mpi_world(int& argc, char**& argv) {
                    ...
                    if (res == MPI_ERR_OTHER) throw std::runtime_error("MPI init failed");
            ...
            public:
                const mpi_world& world() const noexcept { return m_parallel_context.world(); }
                ...
                // thread-safe
                communicator_type get_serial_communicator() { return m_transport_context.get_serial_communicator(); }
                ...
                // thread-safe
                thread_token get_token() noexcept { return m_parallel_context.m_thread_primitives.get_token(); }
