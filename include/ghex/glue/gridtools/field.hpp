...
namespace gridtools {
    ...
    namespace ghex {
        namespace _impl {
            ...
            template<typename T, typename Arch, typename DomainDescriptor, template<class J, J...> class Seq,
                     typename I, I... Is>
        ...
        auto wrap_gt_field(DomainIdType dom_id, const ::gridtools::data_store<Storage, StorageInfo>& ds,
                           typename arch_traits<arch_from_storage<Storage>>::device_id_type device_id = 0) {
            ...
            using sfw_t = typename _impl::get_simple_field_wrapper_type<
                value_t, arch_t, structured::domain_descriptor<domain_id_type, dimension::value>, integer_seq>::type;
        ...
        auto wrap_gt_field(const gt_grid<Transport>& grid, const ::gridtools::data_store<Storage, StorageInfo>& ds,
                           typename arch_traits<arch_from_storage<Storage>>::device_id_type device_id = 0) {
