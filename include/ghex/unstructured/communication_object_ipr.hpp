...
namespace gridtools {
    ...
    namespace ghex {
        ...
        // namespace unstructured {
            ...
            class communication_handle_ipr<Communicator, unstructured::detail::grid<Index>, DomainIdType> {
             ...
             * @tparam DomainIdType domain id type*/
            template<typename Communicator, typename Index, typename DomainIdType>
            class communication_object_ipr<Communicator, unstructured::detail::grid<Index>, DomainIdType> {
                ...
                public:
                    ...
                    using grid_type = unstructured::detail::grid<index_type>;
                    using domain_id_type = DomainIdType;
                    using handle_type = communication_handle_ipr<communicator_type,grid_type,domain_id_type>;
                ...
                private:
                    ...
                    using pack_function_type = std::function<void(void*, const index_container_type&, void*)>; // last argument intended as CUDA stream
                ...
                public:
                    ...
                    // ctors
                    communication_object_ipr(communicator_type comm) :
                        m_valid(false),
                        m_comm(comm) {}
                    ...
                    [[nodiscard]] handle_type exchange(buffer_info_type<Archs,Fields>... buffer_infos) {
                        ...
                        memory_t memory_tuple{&(std::get<buffer_memory<Archs>>(m_mem))...}; // pointers to the buffer memory for the corresponding device
                ...
                private:
                    ...
                    void allocate(Memory mem,
                                  ...
                                  typename arch_traits<Arch>::device_id_type device_id,
                                  O tag_offset) {
...
#endif /* INCLUDED_GHEX_UNSTRUCTURED_COMMUNICATION_OBJECT_IPR_HPP */
