...
TEST_F(mpi_test_fixture, atlas_halo_exchange)
{
    ...
    atlas::functionspace::NodeColumns fs_nodes(
...
TEST_F(mpi_test_fixture, atlas_halo_exchange_multiple_patterns)
{
    ...
    using cpu_double_data_descriptor_t =
        ghex::atlas_data_descriptor<ghex::cpu, domain_id_t, double>;
    ...
    atlas::functionspace::NodeColumns fs_nodes_1(
        mesh, atlas::option::levels(nb_levels) | atlas::option::halo(1));
    ...
    atlas::functionspace::NodeColumns fs_nodes_2(
        mesh, atlas::option::levels(nb_levels) | atlas::option::halo(2));
    ...
    using gpu_double_data_descriptor_t =
        ghex::atlas_data_descriptor<ghex::gpu, domain_id_t, double>;
    ...
    auto gpu_multi_field_1_data =
        atlas::array::make_host_view<int, 2>(fields_1["gpu_multi_field_1"]);
    auto gpu_multi_field_2_data =
        atlas::array::make_host_view<double, 2>(fields_2["gpu_multi_field_2"]);
    for (auto node = 0; node < fs_nodes_1.nb_nodes(); ++node)
    {
        for (auto level = 0; level < fs_nodes_1.levels(); ++level)
        {
    ...
    gpu_int_data_descriptor_t gpu_multi_data_1{
        local_domains_1.front(), 0, fields_1["gpu_multi_field_1"]};
    gpu_double_data_descriptor_t gpu_multi_data_2{
        local_domains_2.front(), 0, fields_2["gpu_multi_field_2"]};
