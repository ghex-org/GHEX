...
#define C_ADD 2
    ...
    bool run(ST& file, context_type& context, Comm comm, int DIM1, int DIM2, int DIM3, int H1m1, int H1p1, int H2m1,
        ...
        domain_descriptor_t my_domain_1{
            pid, coordinate_t{(coords[0]) * DIM1, (coords[1]) * DIM2, (coords[2]) * DIM3},
        ...
        lapse_time1 = ((static_cast<double>(stop1_tv.tv_sec) + 1 / 1000000.0 * static_cast<double>(stop1_tv.tv_usec)) -
    ...
    bool test(int DIM1, int DIM2, int DIM3, int H1m1, int H1p1, int H2m1, int H2p1, int H3m1, int H3p1, int H1m2,
        ...
        */
        ...
        passed = passed and run<std::ostream, 0, 1, 2, true, true, true>(
                                ...
                                H2m2, H2p2, H3m2, H3p2, H1m3, H1p3, H2m3, H2p3, H3m3, H3p3, _a, _b, _c);
        ...
        passed = passed and run<std::ostream, 0, 1, 2, true, true, false>(
                                file, context, comm, DIM1, DIM2, DIM3, H1m1, H1p1, H2m1, H2p1, H3m1, H3p1, H1m2, H1p2,
                                H2m2, H2p2, H3m2, H3p2, H1m3, H1p3, H2m3, H2p3, H3m3, H3p3,
