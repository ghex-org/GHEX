...
bool run(ST &file, context_type& context, Comm comm,
    ...
    auto patterns_1 = gridtools::ghex::make_pattern<gridtools::ghex::structured::grid>(context, halo_gen_1,
            local_domains);
    auto patterns_2 = gridtools::ghex::make_pattern<gridtools::ghex::structured::grid>(context, halo_gen_2,
            local_domains);
    auto patterns_3 = gridtools::ghex::make_pattern<gridtools::ghex::structured::grid>(context, halo_gen_3,
            local_domains);

    using communication_object_t = gridtools::ghex::communication_object<decltype(patterns_1)::value_type,
